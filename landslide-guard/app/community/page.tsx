...
export default function CommunityPage() {
  const [selectedLocationId, setSelectedLocationId] = useState(DEMO_LOCATIONS[0].id);

  const location = DEMO_LOCATIONS.find((l) => l.id === selectedLocationId)!;
  const instructions = SAFETY_INSTRUCTIONS[location.riskLevel];
